...
const Translations = {
  ...
  friends: {
    lastOnlineToday: "friends.last-online-today",
    lastOnlineYesterday: "friends.last-online-yesterday",
    lastOnlineDaysAgo: "friends.last-online-days-ago",
    lastOnlineWeeksAgo: "friends.last-online-weeks-ago",
    lastOnlineMonthsAgo: "friends.last-online-months-ago",
    lastOnlineYearsAgo: "friends.last-online-years-ago",
    friends: "friends.friends",
    requests: "friends.requests",
    addFriend: "friends.add-friend",
    outgoingRequests: "friends.outgoing-requests",
    incomingRequests: "friends.incoming-requests",
    noIncoming: "friends.no-incoming",
    noOutgoing: "friends.no-outgoing",
    lastActive: "friends.last-active",
    motivation: "friends.motivation",
    level: "friends.level",
    lastAchievements: "friends.last-achievements",
